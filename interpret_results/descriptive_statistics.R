...
data$experiencelevel[data$interpreter %in% c("F5", "K20", "L20", "E5")] <- 1
data$experiencelevel[data$interpreter %in% c("D5", "C5", "I20", "J20")] <- 2
data$experiencelevel[data$interpreter %in% c("A5", "B5", "H20", "G20")] <- 3
data$experiencelevel[data$interpreter %in% c("X5", "X20")] <- 4
